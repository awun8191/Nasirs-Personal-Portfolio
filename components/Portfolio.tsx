                    ...
                    <ScrollReveal delay={index * 50} animation="animate-fade-up" className="w-full h-full flex-grow">
                      ...
                      >
                          ...
                          <div className="p-6 md:p-12 lg:p-16 flex flex-col flex-grow justify-center items-start text-left bg-white dark:bg-gray-800 relative z-30">
                              ...
                              <button className="w-full md:w-auto px-6 py-3.5 lg:px-8 lg:py-4 bg-dark dark:bg-white text-white dark:text-dark rounded-full font-bold shadow-xl hover:bg-sage-600 dark:hover:bg-gray-200 hover:scale-[1.02] active:scale-95 transition-all duration-300 flex items-center justify-center gap-2 group/btn text-sm lg:text-base">
                                View Case Study 
